<template>
	<view>
		<view class="tabr" :style="{top:headerTop}">
			<view :class="{on:typeClass=='goods'}" @tap="switchType('goods')">工作({{goodsList.length}})</view>
			<view :class="{on:typeClass=='shop'}"  @tap="switchType('shop')">人才({{shopList.length}})</view>
...
<script>
	...
	export default {
		data() {
			return {
				goodsList:[
					{id:1,img:'/static/img/goods/p1.jpg',name:'标题',spec:'',price:2000,number:1,selected:false},
					{id:2,img:'/static/img/goods/p1.jpg',name:'标题',spec:'',price:2000,number:1,selected:false},
					{id:3,img:'/static/img/goods/p1.jpg',name:'标题',spec:'',price:2000,number:1,selected:false},
				],
				shopList:[
					{id:1,name:"标题",img:"/static/img/shop/1.jpg"},
					{id:2,name:"标题",img:"/static/img/shop/2.jpg"},
					{id:3,name:"标题",img:"/static/img/shop/3.jpg"},
					{id:4,name:"标题",img:"/static/img/shop/4.jpg"}
				],
				headerTop:0,
				//控制滑动效果
				typeClass:'goods',
