...
<script>
	...
	export default {
		data() {
			return {
				couponValidList:[
					// {id:2,title:"100元",termStart:"2019-04-01",termEnd:"2019-05-30",ticket:"100",criteria:"使用"},
				],
				couponinvalidList:[
					// {id:1,title:"10元",termStart:"2019-04-01",termEnd:"2019-05-30",ticket:"10",criteria:"使用"},
				],
				headerTop:0,
				//控制滑动效果
				typeClass:'valid',
